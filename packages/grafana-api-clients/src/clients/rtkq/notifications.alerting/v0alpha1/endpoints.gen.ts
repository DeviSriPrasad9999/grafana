...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      listReceiverTypeSchema: build.query<ListReceiverTypeSchemaApiResponse, ListReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas`,
          params: {
            pretty: queryArg.pretty,
            allowWatchBookmarks: queryArg.allowWatchBookmarks,
            continue: queryArg['continue'],
        ...
        providesTags: ['ReceiverTypeSchema'],
      }),
      createReceiverTypeSchema: build.mutation<CreateReceiverTypeSchemaApiResponse, CreateReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas`,
          method: 'POST',
          body: queryArg.receiverTypeSchema,
          params: {
            pretty: queryArg.pretty,
            dryRun: queryArg.dryRun,
            fieldManager: queryArg.fieldManager,
        ...
        invalidatesTags: ['ReceiverTypeSchema'],
      }),
      deletecollectionReceiverTypeSchema: build.mutation<
        DeletecollectionReceiverTypeSchemaApiResponse,
        DeletecollectionReceiverTypeSchemaApiArg
      >({
        query: (queryArg) => ({
          url: `/receivertypeschemas`,
          method: 'DELETE',
      ...
      getReceiverTypeSchema: build.query<GetReceiverTypeSchemaApiResponse, GetReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas/${queryArg.name}`,
          params: {
            pretty: queryArg.pretty,
          },
        }),
      ...
      replaceReceiverTypeSchema: build.mutation<ReplaceReceiverTypeSchemaApiResponse, ReplaceReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas/${queryArg.name}`,
          method: 'PUT',
          body: queryArg.receiverTypeSchema,
      ...
      deleteReceiverTypeSchema: build.mutation<DeleteReceiverTypeSchemaApiResponse, DeleteReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas/${queryArg.name}`,
          method: 'DELETE',
          params: {
      ...
      updateReceiverTypeSchema: build.mutation<UpdateReceiverTypeSchemaApiResponse, UpdateReceiverTypeSchemaApiArg>({
        query: (queryArg) => ({
          url: `/receivertypeschemas/${queryArg.name}`,
          method: 'PATCH',
          body: queryArg.patch,
...
export type ListReceiverTypeSchemaApiResponse = /** status 200 OK */ ReceiverTypeSchemaList;
export type ListReceiverTypeSchemaApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** allowWatchBookmarks requests watch events with type "BOOKMARK". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. */
  allowWatchBookmarks?: boolean;
...
export type CreateReceiverTypeSchemaApiResponse = /** status 200 OK */
  | ReceiverTypeSchema
  | /** status 201 Created */ ReceiverTypeSchema
  | /** status 202 Accepted */ ReceiverTypeSchema;
export type CreateReceiverTypeSchemaApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed */
  dryRun?: string;
  ...
  /** fieldValidation instructs the server on how to handle objects in the request (POST/PUT/PATCH) containing unknown or duplicate fields. Valid values are: - Ignore: This will ignore any unknown fields that are silently dropped from the object, and will ignore all but the last duplicate field that the decoder encounters. This is the default behavior prior to v1.23. - Warn: This will send a warning via the standard warning response header for each unknown field that is dropped from the object, and for each duplicate field that is encountered. The request will still succeed if there are no other errors, and will only persist the last of any duplicate fields. This is the default in v1.23+ - Strict: This will fail the request with a BadRequest error if any unknown fields would be dropped from the object, or if any duplicate fields are present. The error returned from the server will contain all unknown and duplicate fields encountered. */
  fieldValidation?: string;
  receiverTypeSchema: ReceiverTypeSchema;
};
export type DeletecollectionReceiverTypeSchemaApiResponse = /** status 200 OK */ Status;
export type DeletecollectionReceiverTypeSchemaApiArg = {
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
  /** The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the "next key".
...
export type GetReceiverTypeSchemaApiResponse = /** status 200 OK */ ReceiverTypeSchema;
export type GetReceiverTypeSchemaApiArg = {
  /** name of the ReceiverTypeSchema */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
};
export type ReplaceReceiverTypeSchemaApiResponse = /** status 200 OK */
  | ReceiverTypeSchema
  | /** status 201 Created */ ReceiverTypeSchema;
export type ReplaceReceiverTypeSchemaApiArg = {
  /** name of the ReceiverTypeSchema */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type DeleteReceiverTypeSchemaApiResponse = /** status 200 OK */ Status | /** status 202 Accepted */ Status;
export type DeleteReceiverTypeSchemaApiArg = {
  /** name of the ReceiverTypeSchema */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdateReceiverTypeSchemaApiResponse = /** status 200 OK */
  | ReceiverTypeSchema
  | /** status 201 Created */ ReceiverTypeSchema;
export type UpdateReceiverTypeSchemaApiArg = {
  /** name of the ReceiverTypeSchema */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type ReceiverTypeSchemaSelectOption = {
  description: string;
  label: string;
  value: string | number;
};
export type ReceiverTypeSchemaShowWhen = {
  field: string;
  is: string;
};
export type ReceiverTypeSchemaField = {
  dependsOn: string;
  description: string;
  element: string;
  inputType: string;
  ...
  required: boolean;
  secure: boolean;
  selectOptions?: ReceiverTypeSchemaSelectOption[];
  showWhen: ReceiverTypeSchemaShowWhen;
  subformOptions?: ReceiverTypeSchemaField[];
  validationRule: string;
};
export type ReceiverTypeSchemaIntegrationSchemaVersion = {
  canCreate: boolean;
  deprecated?: boolean;
  info?: string;
  options: ReceiverTypeSchemaField[];
  typeAlias?: string;
  version: string;
};
export type ReceiverTypeSchemaSpec = {
  ...
  name: string;
  type: string;
  versions: ReceiverTypeSchemaIntegrationSchemaVersion[];
};
export type ReceiverTypeSchema = {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion: string;
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind: string;
  metadata: ObjectMeta;
  spec: ReceiverTypeSchemaSpec;
};
export type ReceiverTypeSchemaList = {
  /** APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources */
  apiVersion?: string;
  items: ReceiverTypeSchema[];
  /** Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
  kind?: string;
  metadata: ListMeta;
};
...
export const {
  ...
  useListReceiverTypeSchemaQuery,
  useLazyListReceiverTypeSchemaQuery,
  useCreateReceiverTypeSchemaMutation,
  useDeletecollectionReceiverTypeSchemaMutation,
  useGetReceiverTypeSchemaQuery,
  useLazyGetReceiverTypeSchemaQuery,
  useReplaceReceiverTypeSchemaMutation,
  useDeleteReceiverTypeSchemaMutation,
  useUpdateReceiverTypeSchemaMutation,
